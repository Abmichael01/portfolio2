...
const projects = [
    ...
    {
        name: "VORTEX.IO",
        description: "This is a simmple landing page for a crypto updates group",
    ...
    {
        name: "SHORTLY",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam commodi facilis vel sequi sunt dicta fugit ea, vitae aut.",
        link: "#",
        github: "#",
        image: shortly,
        stack: ["React", "Django", "CSS", "Javascript"],
        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                {projects.map((project, index) => (
                    <div className='p-[1.5px] rounded-xl bg-gradient-to-b from-gray-800 via-blue-500 to-gray-800 shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl'>
                        <div
                            key={index}
                            className="flex flex-col overflow-hidden bg-customBg rounded-xl h-full"
                        >
